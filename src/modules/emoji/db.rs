...
#[allow(dead_code)]
pub(crate) struct ModEmojiEmojiUse {
    pub(crate) id: i64,
...
impl Emoji {
    pub(crate) fn from_serenity(val: serenity::Emoji, guild_id: u64) -> Self {
        Emoji {
            id: val.id.get(),
            guild_id,
            name: val.name,
...
pub(crate) async fn save_emoji_use(
    ...
    sqlx::query!(
        "
            INSERT INTO mod_emoji_emoji_uses (
                guild_id,
                emoji_id,
                name,
                animated,
